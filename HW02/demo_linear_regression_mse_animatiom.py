...
def update(frame):
    ...
    yy = mse_m_array[frame] * xx + mse_b_array[frame]
    print(xx)
...
if __name__ == "__main__":
    ...
    animation = FuncAnimation(fig, update, len(mse_m_array), interval=100)

    # Save the animation as a gif (optional)
    animation.save('animated_mse_graph.gif', writer='imagemagick', fps=30)
